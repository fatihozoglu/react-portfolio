  ...
  return (
    <div className="projects-container">
      ...
      <Project
        ...
        projectDesc={"A Linkedin clone is created with Bootstrap 5"}
        demoLink={"#"}
        githubLink={
          "https://github.com/fatihozoglu/kodluyoruz-projeler/tree/main/Bootstrap_odev_3"
        }
      />
      <Project
        ...
        demoLink={"#"}
        githubLink={
          "https://github.com/fatihozoglu/kodluyoruz-projeler/tree/main/Binary_Calculator"
        }
      />
    </div>
  );
